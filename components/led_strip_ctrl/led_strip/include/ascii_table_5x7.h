#ifndef __ASCII_TABLE_5X7_H__
#define __ASCII_TABLE_5X7_H__
#include <stdint.h>

/**
 * @brief Declare the 5x7 ASCII table with font data.
 * 
 * 	Data are row oriented (from top to bottom), thus 7 bytes of data for each character.
 * 	Data don't contain the spaces before and after the character.
 * 	The 1st index is position (0-255) of character in the 2D array.
 * 	The 2nd index refers to the row (0-6) of the selected character in the 1st index.
 * 
 */
const uint16_t ascii_tab_5x7[256][7] = {
